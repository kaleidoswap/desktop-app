...
function CreateOrderModal({
  ...
  const { dialogRef, dialogProps } = useDialog({
    label: t('dca.createOrder', 'New DCA Order'),
    onClose,
  })
  return createPortal(
    <div
    ...
    >
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6 pointer-events-none">
        <div
          className="bg-surface-base p-6 sm:p-8 rounded-3xl border border-border-subtle/50 max-w-xl w-full shadow-2xl max-h-[calc(100vh-2rem)] overflow-y-auto pointer-events-auto"
          ref={dialogRef}
          {...dialogProps}
        >
