          ...
          >
            <div className="bg-surface-base border border-border-default/60 rounded-2xl shadow-2xl w-full max-w-sm mx-4 p-6 animate-scaleIn">
              ...
              <div className="flex gap-3 mt-5">
                ...
                <button
                  className="flex-1 py-2.5 rounded-lg bg-gradient-to-r from-orange-500 to-yellow-600 text-white text-sm font-bold shadow-md shadow-orange-500/20 hover:shadow-orange-500/40 transition-all flex items-center justify-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed"
