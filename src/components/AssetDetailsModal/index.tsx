      ...
      <div className="p-6">
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-content-secondary">{asset.name}</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-surface-elevated/50 p-4 rounded-lg">
            <p className="text-content-secondary text-sm mb-1">Asset ID</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-surface-elevated/50 p-4 rounded-lg">
            <p className="text-content-secondary text-sm mb-1">Precision</p>
            <p className="text-white">{asset.precision}</p>
          </div>

          <div className="bg-surface-elevated/50 p-4 rounded-lg">
            <p className="text-content-secondary text-sm mb-1">Total Supply</p>
        ...
        <div className="grid grid-cols-1 gap-4 mb-6">
          <div className="bg-surface-elevated/50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <p className="text-content-secondary text-sm mb-1 flex items-center">
                  Future
                  {isDifferentBalances && (
                    <div className="relative group ml-2">
                      <Info className="w-4 h-4 text-yellow-500" />
                      <div className="absolute bottom-full mb-2 left-0 bg-surface-overlay text-white text-xs rounded py-1 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none w-60">
              ...
              <div>
                <p className="text-content-secondary text-sm mb-1">Settled</p>
              ...
              <div>
                <p className="text-content-secondary text-sm mb-1">Spendable</p>
                <p className="text-white">
          ...
          <div className="bg-surface-elevated/50 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                <p className="text-content-secondary text-sm mb-1">Outbound</p>
                <p className="text-white">
              ...
              <div>
                <p className="text-content-secondary text-sm mb-1">Inbound</p>
                <p className="text-white">
        ...
        <div className="bg-surface-elevated/50 p-4 rounded-lg mb-6">
          <h4 className="text-white font-medium mb-2">Balance Explanations</h4>
          <ul className="text-sm text-content-secondary space-y-2">
            <li>
              <span className="text-primary font-medium">Future:</span> Total
              balance including pending transactions
            </li>
            <li>
              <span className="text-primary font-medium">Settled:</span> Balance
        ...
        <div className="mt-6 bg-surface-elevated/30 p-4 rounded-lg border border-blue-500/20">
